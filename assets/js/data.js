...
const DB = {
  ...
  taiKhoan: [
    {
      ...
      quyen: ['tongquan', 'nhansu', 'kinhdoanh', 'khovan', 'ketoan'],
      xemLuong: true
    },
    {
  ...
  nhanSu: {
    ...
    danhSach: [
      { ten: 'Phạm Khương Duy',  vt: 'PD', cv: 'Quản lý kho',        bp: 'Kho vận',   pn: 'Công ty', tt: 'ok',   ttx: 'Đã ký HĐ', vao: '03/2025', luong: '22.000.000' },
      { ten: 'Phan Thị Hằng',    vt: 'PH', cv: 'Kế toán trưởng',     bp: 'Kế toán',   pn: 'Công ty', tt: 'ok',   ttx: 'Đã ký HĐ', vao: '01/2025', luong: '25.000.000' },
      { ten: 'Vũ Lan Hương',     vt: 'VH', cv: 'Hành chính nhân sự', bp: 'HCNS',      pn: 'Công ty', tt: 'warn', ttx: 'Thử việc', vao: '05/2026', luong: '11.000.000' },
      { ten: 'Nguyễn Thị Huyền', vt: 'NH', cv: 'Vận hành sàn',       bp: 'Kinh doanh',pn: 'Công ty', tt: 'ok',   ttx: 'Đã ký HĐ', vao: '08/2025', luong: '14.000.000' },
      { ten: 'Trần Văn Nam',     vt: 'TN', cv: 'Nhân viên kho',      bp: 'Kho vận',   pn: 'HKD',     tt: 'warn', ttx: 'Chờ ký',   vao: '06/2024', luong: '9.500.000' },
      { ten: 'Lê Thị Mai',       vt: 'LM', cv: 'Đóng gói',           bp: 'Kho vận',   pn: 'HKD',     tt: 'warn', ttx: 'Chờ ký',   vao: '09/2024', luong: '8.500.000' },
      { ten: 'Hoàng Minh Tuấn',  vt: 'HT', cv: 'Nhân viên kho',      bp: 'Kho vận',   pn: 'HKD',     tt: 'danger', ttx: 'Cần trao đổi', vao: '02/2025', luong: '9.000.000' },
      { ten: 'Đỗ Thu Trang',     vt: 'ĐT', cv: 'Kế toán công nợ',    bp: 'Kế toán',   pn: 'Công ty', tt: 'ok',   ttx: 'Đã ký HĐ', vao: '04/2025', luong: '12.000.000' },
      { ten: 'Ngô Quang Hải',    vt: 'NQ', cv: 'CSKH',               bp: 'Kinh doanh',pn: 'HKD',     tt: 'warn', ttx: 'Chờ ký',   vao: '11/2025', luong: '10.000.000' },
      { ten: 'Vương Thị Yến',    vt: 'VY', cv: 'Đóng gói (PT)',      bp: 'Kho vận',   pn: 'HKD',     tt: 'mute', ttx: 'Parttime', vao: '03/2026', luong: '—' }
    ],
    chuyenDoi: [
