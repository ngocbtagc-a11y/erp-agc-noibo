...
const QUYEN_THEO_VAI_TRO = {
  ...
  // 22/08/2026, thu hẹp phạm vi 23/08/2026 theo nguyên tắc "System Admin
  // không tự có quyền nghiệp vụ" — xem docs/PERMISSION_ARCHITECTURE.md).
  // XEM được mọi tab (module access) nhưng KHÔNG tự có quyền thao tác
  // nghiệp vụ (Kho/Sản phẩm/Tài sản/Shopee/Vận hành/Chính sách ca) — các
  // quyền đó nằm ở các bảng QUYEN_* riêng bên dưới, admin_he_thong CỐ Ý
  // không có mặt ở đó. Muốn làm nghiệp vụ thì tài khoản đó cần thêm 1 vai
  // trò nghiệp vụ thật (VD kiêm quan_ly_kho), không tự động có qua đây.
...
/* ---- Quyền module Đăng ký ca / Xếp ca ------------------------------------
   ...
   vai trò với them_nhan_su (giam_doc, pho_giam_doc, hcns).
