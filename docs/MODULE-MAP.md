...
| R&D sản phẩm (NPD) | P. Kinh Doanh-MKT | `src/rnd.js` | `/api/rnd/*` | `rnd_du_an`, `rnd_buoc`, `rnd_lich_su` | **PILOT** (mới 06/09/2026, chưa đi trọn 1 vòng A→Z bằng dự án thật) | Employee Core, Product/SKU Master | `nhan_su`, `san_pham` |
