...
| Tồn kho — nhập/xuất TỪNG PHIẾU | `giao_dich_kho`, `lo_hang` | Kho vận (Quản lý kho + Nhân viên kho) | P. Kho Vận-Sản Xuất | Kế toán trưởng xem giá vốn | Sổ cái bất biến, không sửa trực tiếp. Việc hằng ngày — 17 bạn part-time làm được |
| Tồn kho — **NẠP HÀNG LOẠT từ file** | `giao_dich_kho`, `lo_hang` | **Quản lý kho + Kế toán trưởng + Admin** (Sếp Ngọc chốt 09/09/2026) | P. Kho Vận-Sản Xuất | Nhân viên kho KHÔNG nạp, KHÔNG xem/gỡ lượt nạp | Một lần bấm ghi hàng nghìn dòng vào sổ cái — khác về CHẤT với một phiếu lẻ. Cờ riêng `QUYEN_KHO.nap_luot`, KHÔNG dùng `thao_tac` |
| Tồn kho — **PHIẾU ĐIỀU CHỈNH** | `giao_dich_kho` (`loai='dieu_chinh'`) | **Quản lý kho + Kế toán trưởng + Admin** (Sếp Ngọc chốt 09/09/2026) | P. Kho Vận-Sản Xuất + P. Support | Nhân viên kho chỉ xem | Cửa duy nhất ghi thẳng một con số vào sổ cái mà không có chứng từ mua–bán đứng sau. Kế toán trưởng là người đối chiếu sổ với số kiểm kê nên phải lập được. Cờ riêng `QUYEN_KHO.dieu_chinh`, KHÔNG dùng `quan_ly` (cờ đó còn đèo quyền sửa mã hàng) |
