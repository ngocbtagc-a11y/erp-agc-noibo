...
function tuKiem() {
  ...
  console.log('  ✅ Ca đối chứng: 14/14 mẫu bẩn BỊ BẮT · 9/9 mẫu sạch KHÔNG bị bắt oan — máy quét có hiệu lực.');
  console.log('  ✅ Mặt trận ③ (cửa mô-đun): mẫu bẩn LỌT lưới ① và BỊ lưới ③ bắt — lỗ thủng REV-0060 vòng 2 đã bịt.');
}
